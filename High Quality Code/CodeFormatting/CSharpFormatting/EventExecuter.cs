namespace CSharpFormatting
{
    ...
    public class EventExecuter
    {
        ...
        public static class Messages
        {
            ...
            {
                output.Append(string.Format("Event added{0}", Environment.NewLine));
            }
            ...
            public static void EventDeleted(int x)
            {
                ...
                {
                    output.AppendFormat(string.Format("{0} events deleted{1}", x, Environment.NewLine));
                }
            }

            public static void NoEventsFound()
            {
                output.Append(string.Format("No events found{0}", Environment.NewLine));
            }
